...
ENV APACHE_MAVEN_VERSION 3.9.16
ENV APACHE_ARTEMIS_VERSION 2.55.0
...
\
        && (curl -sfSL "https://dlcdn.apache.org/artemis/artemis/${APACHE_ARTEMIS_VERSION}/apache-artemis-${APACHE_ARTEMIS_VERSION}-bin.tar.gz" | tar xzvfC - /opt) \
